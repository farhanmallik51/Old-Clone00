...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/farhanmallik51/approval.txt/blob/main/Ap.txt"])
...
def notice():
	...
	subprocess.check_output(["am", "start", "https://t.me/zexx.termux"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/farhanmallik51/approval.txt/blob/main/Ap.txt').text
			if basesplit in plr:
				key = basesplit
